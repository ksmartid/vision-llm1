# -*- coding: utf-8 -*-
"""
Step 3/3: 실시간 객체 검출 - Contour Detection과 중심점 Overlay (최종본)
원본: object_detection.py (단계별로 재구성)
"""


# %% [markdown]
# ### 3단계: Contour Detection으로 객체의 중심과 반지름 계산
#
# 정제된 마스크에서 Contour(윤곽선)를 찾아 가장 큰 영역을 객체로 간주하고,
# 무게중심(centroid)과 최소 외접원 반지름을 구해 원본 프레임 위에 표시합니다.
#
# 이 파일의 결과는 원본 `object_detection.py`와 동일합니다.
